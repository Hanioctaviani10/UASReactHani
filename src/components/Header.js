      ...
      <header className="bg-yellow text-green navbar navbar-expand-md navbar-dark d-print-none">
        <div className="container-xl">
          ...
          <h1 className="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <Link to="/">
              <img
                src="https://o.remove.bg/downloads/b9811c84-c702-4dff-861f-629224431242/best-bakery-in-town-logo-design-template-36cc6d8197e6991a1a6e9866e4e64919_screen-removebg-preview.png"
                width="110"
                height="32"
                alt="Tabler"
